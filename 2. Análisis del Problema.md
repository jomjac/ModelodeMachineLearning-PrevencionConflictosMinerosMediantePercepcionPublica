...
| **Elemento**            | **Descripción**                                                                                                                                                          |
|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Decisiones Clave**    | <br>- Selección de fuente de datos, ya sea redes sociales, encuestas, registros, entre otros o incluir todos los medios de las redes sociales.     |
