...
| **Métricas Relevantes** | - **Indice de satisfacción:** analizar el porcentaje de positivismo respecto a las medidas implementadas de la minera<br>- **Incidencia de Conflictos Sociales:** Registro de insidencia de conflictos en un periodo de tiempo <br>- **Impacto económico:** Muestra de los beneficios económicos en la población, ya sea por generación de empleo o inversiones.      |
| **Palancas Relevantes** | - **Respuestas rápidas a críticas:** Establecer un sistema de monitoreo en tiempo real para responder rápidamente a críticas y preocupaciones expresadas en redes sociales y medios.<br>- **Capacitación:** Capacitar a los empleados y líderes en habilidades de comunicación y manejo de crisis.<br>-  
